SMODS.Joker {
	key = "ice_pop_b",			-- Object ID, acessed with j_joaf_[key]
	atlas = "JOAFJokers",		-- Spritesheet to use, initalized in main script
	pos = {x = 9, y = 5},		-- works on a +1 increment, not based off of pixels
	...
	calculate = function(self, card, context)
		...
		if context.end_of_round and context.cardarea == G.jokers then
			card.ability.extra.chips = card.ability.extra.chips - card.ability.extra.decrease
