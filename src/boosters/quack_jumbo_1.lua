SMODS.Booster {
    key = "quack_jumbo_1",           -- Class prefix of p, for pack probably
    atlas = "JOAFBoosters",
    pos = {x=2,y=1},
    ...
    config = { extra = 4, choose = 1 },      -- Extra is the amount of cards, and choose is the amount of cards that can be picked

    loc_txt = {
		name = 'Jumbo Quack Pack',
