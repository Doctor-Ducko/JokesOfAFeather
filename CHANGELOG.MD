...
- Art Changes
    - Updated "Joker?"'s color pallete
    - Added a hyphen in Irritating Joker's sprite
    

- Balance Changes
    - Family Guy rarity rate nerfed from 2% -> 0.5%
...
### Fixed
- Talisman being in the JSON as a dependency

## [1.1.0] - 2025-08-04

### Fixed
- Talisman being required to load the mod
